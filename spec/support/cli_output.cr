...
def captured(&) : {String, String}
  ...
  original_stream = Cogiteer::Output.stream
  original_error = Cogiteer::Output.error_stream

  Cogiteer::Output.stream = printed
  Cogiteer::Output.error_stream = warned
  begin
    yield
  ensure
    Cogiteer::Output.stream = original_stream
    Cogiteer::Output.error_stream = original_error
  end
